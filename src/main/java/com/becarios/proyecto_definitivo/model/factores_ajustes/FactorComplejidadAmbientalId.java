...
/**
 * FactorComplejidadAmbientalId generated by hbm2java
 */
@Embeddable
public class FactorComplejidadAmbientalId implements java.io.Serializable {

    private int idProyecto;
    private String nombre;

    public FactorComplejidadAmbientalId() {
    }

    public FactorComplejidadAmbientalId(int idProyecto, String nombre) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof FactorComplejidadAmbientalId))
            return false;
        FactorComplejidadAmbientalId castOther = (FactorComplejidadAmbientalId) other;
