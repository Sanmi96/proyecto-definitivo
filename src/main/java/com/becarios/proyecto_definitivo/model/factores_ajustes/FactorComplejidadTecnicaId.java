...
/**
 * FactorComplejidadTecnicaId generated by hbm2java
 */
@Embeddable
public class FactorComplejidadTecnicaId implements java.io.Serializable {

    private int idProyecto;
    private String nombre;

    public FactorComplejidadTecnicaId() {
    }

    public FactorComplejidadTecnicaId(int idProyecto, String nombre) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof FactorComplejidadTecnicaId))
            return false;
        FactorComplejidadTecnicaId castOther = (FactorComplejidadTecnicaId) other;
