...
/**
 * ArquitecturaReferenciaId generated by hbm2java
 */
@Embeddable
public class ArquitecturaReferenciaId implements java.io.Serializable {

    private int idProyecto;
    private String nombre;

    public ArquitecturaReferenciaId() {
    }

    public ArquitecturaReferenciaId(int idProyecto, String nombre) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof ArquitecturaReferenciaId))
            return false;
        ArquitecturaReferenciaId castOther = (ArquitecturaReferenciaId) other;
