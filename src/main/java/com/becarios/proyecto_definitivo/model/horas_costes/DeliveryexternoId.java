...
/**
 * DeliveryexternoId generated by hbm2java
 */
@Embeddable
public class DeliveryexternoId implements java.io.Serializable {

    private int idProyecto;
    private String nombre;

    public DeliveryexternoId() {
    }

    public DeliveryexternoId(int idProyecto, String nombre) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof DeliveryexternoId))
            return false;
        DeliveryexternoId castOther = (DeliveryexternoId) other;
