...
/**
 * GobiernoexternoId generated by hbm2java
 */
@Embeddable
public class GobiernoexternoId implements java.io.Serializable {

    private int idProyecto;
    private String nombre;

    public GobiernoexternoId() {
    }

    public GobiernoexternoId(int idProyecto, String nombre) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof GobiernoexternoId))
            return false;
        GobiernoexternoId castOther = (GobiernoexternoId) other;
