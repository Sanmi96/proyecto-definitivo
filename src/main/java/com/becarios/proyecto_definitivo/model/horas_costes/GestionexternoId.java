...
/**
 * GestionexternoId generated by hbm2java
 */
@Embeddable
public class GestionexternoId implements java.io.Serializable {

    private int idProyecto;
    private String nombre;

    public GestionexternoId() {
    }

    public GestionexternoId(int idProyecto, String nombre) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof GestionexternoId))
            return false;
        GestionexternoId castOther = (GestionexternoId) other;
