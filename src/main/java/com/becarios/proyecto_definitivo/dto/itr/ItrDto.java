package com.becarios.proyecto_definitivo.dto.itr;
...
public class ItrDto {
    ...
    public ItrDto(int idProyecto, double gbsCenitGdo1, double gbsCenitGdo2, double gbsCenitGdo3, double gbsCenitGdo4,
